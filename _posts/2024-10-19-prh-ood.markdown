...
The code for experiments and analysis in this paper is available on GitHub [here]([https://github.com/rokosbasilisk/prh-experiments](https://github.com/rokosbasilisk/platonic-rep/)).
